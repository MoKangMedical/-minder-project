# -minder-project API文档

## 概述

本文档描述了-minder-project项目的API接口规范和使用方法。
...
```bash
# 克隆仓库
git clone https://github.com/MoKangMedical/-minder-project.git
cd -minder-project
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/var/log/-minder-project/app.log'),
...
- 项目主页: https://github.com/MoKangMedical/-minder-project
